                            ...
                            <h1 class="hidden">바디리스트</h1>
                                ...
                                <div >
                                    ...
                                    <div class=my-page-main-box>
                                        <div class='flex'>
                                                <a href=""><div class="tab-btn highlighted">내 글</div></a>
                                                <a href="comment-list.html"><div class="tab-btn unhighlighted">내 댓글</div></a>
                                                ...
                                                <tbody class="table-content">
                                                    <tr>
                                                        ...
                                                        <td class="table-title">
                                                            <a href="">회회ffdfgdgdf신 새로운 이벤트가 등록됐습니다.</a>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="table-title">
                                                            <a href="">회회fgdgfdgdfgffggdfgffgjfhffdfgdgjfhffdfgdgdf신 새로운 이벤트가 등록됐습니다.</a>
                                                        </td>
                                                        <td class="table-comment">[20]</td>
                                                        <td class="table-time">2018.12.09 17:38</td>
                                                        <td class="table-view"><img src="/image/icon/eye-16.png"> <span>201</span></td>
