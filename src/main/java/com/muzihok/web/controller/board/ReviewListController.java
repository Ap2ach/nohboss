...
public class ReviewListController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String dcId = request.getParameter("d");
		// °Ô½Ã±Û Äõ¸®
		List<BoardView> list = service.getBoardViewList(boardCategory, page, sort, dcId);
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("../../WEB-INF/views/board/review/list.jsp");
